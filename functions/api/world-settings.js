...
const KNOWN_KEYS = new Set(["lanterns", "stars", "moon"]);

// Solo alcune chiavi accettano anche un "value" oltre a enabled (es. la luna: la fase scelta,
// "auto" o un indice 0-7) — allowlist dei valori validi per non lasciare che il client scriva
// testo arbitrario nella colonna.
const VALID_VALUES = {
