...
export type WorldSettingKey = 'lanterns' | 'stars' | 'moon' | 'theme' | 'sparkles';
...
export class WorldSettingsService {
  ...
  readonly settings = signal<Record<WorldSettingKey, boolean>>({ lanterns: true, stars: true, moon: true, theme: true, sparkles: true });
