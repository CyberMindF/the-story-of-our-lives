...
export const WORLD_PLACES: readonly WorldPlace[] = [
  ...
  { id: 'carte', emoji: '🃏', route: '/tavolo-da-gioco/carte', fallbackName: 'Le Carte Collezionabili', fallbackDescription: 'Bustine, rarità e scambi con carte che siamo noi.', group: 'giochi', parentId: 'tavolo-da-gioco' },
