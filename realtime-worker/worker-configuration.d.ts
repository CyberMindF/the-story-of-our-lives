/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=realtime-worker/wrangler.jsonc realtime-worker/worker-configuration.d.ts` (hash: 40ec3d542cce7a6eb610bf75901d4a6d)
// Runtime types generated with workerd@1.20260801.1 2026-08-26 nodejs_compat
interface __BaseEnv_Env {
	REALTIME: DurableObjectNamespace<import("./src/index").RealtimeRoom>;
}
