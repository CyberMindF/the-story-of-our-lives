-- La lista fissa ha una nuova voce con ID stabile 78. Ricreiamo soltanto il CHECK,
-- preservando integralmente gli stati già salvati.
CREATE TABLE together_activity_status_new (
    activity_id INTEGER PRIMARY KEY CHECK (activity_id BETWEEN 1 AND 78),
